...
export default function ProjectCard({ title, href, img }: ProjectCardProps) {
  return (
    <div
      ...
      className="flex h-[326px] transition-all duration-300 hover:scale-105 cursor-pointer bg-contain relative bg-no-repeat bg-center rounded-lg justify-center items-center min-w-[320px] bg-dark-300"
    >
